...
public class z002_GwwkTrust_2 {
    static Shan shan;

    private static void add_to_ruler_list(ArrayList<Kingdom> ruler, String str, ArrayList<Kingdom> kingdoms) {
    ...
    public static void main(String args[]) throws IOException{
        ...
        shan = new Shan();
        ArrayList<Kingdom> ruler = new ArrayList<>();
        ...
        add_to_ruler_list(ruler,str,kingdoms);
